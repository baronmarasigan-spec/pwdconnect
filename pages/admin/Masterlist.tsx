        ...
        <div className="bg-slate-50 w-full max-w-4xl max-h-[90vh] rounded-[2.5rem] shadow-2xl relative z-20 flex flex-col overflow-hidden animate-scale-up border border-white">
          <div className="bg-[#1e419c] p-8 text-white flex items-center justify-between shrink-0">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-xl font-bold uppercase tracking-tight">{fullName}</h2>
                  ...
                  <tr key={record.id || idx} className="hover:bg-slate-50/80 transition-colors group">
                    ...
                    <td className="p-6 text-right border-b border-slate-100">
                      <button 
                          ...
                          className="px-4 py-2 bg-white border border-slate-200 text-[#1e419c] rounded-xl font-bold text-[9px] uppercase tracking-widest hover:bg-[#1e419c] hover:text-white hover:border-[#1e419c] transition-all shadow-sm active:scale-95"
                      >
                          View
                      </button>
                    </td>
